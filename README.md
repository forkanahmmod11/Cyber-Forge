...
```
Analyzes authorized application/server telemetry and produces a JSON activity-risk report. It does not bypass authentication or retrieve private logs from third-party websites.
